...
Step1: What will Prophet do?
      1. Prophet will accept the GitHub data from flask microservice and will forecast the data for past 1 year based on past 30 days
      2. This graph will be stored as image in gcloud storage.
      3. The image URL are then returned back to flask microservice.
...
Step3: Deploying Prophet to gcloud platform
       ...
       2. Steps to follow while creating Prophet gcloud project:
            1. Go to GCP Platform, create a Prophet gcloud project.enable the following:
               a.billing account
               b.Conatiner Registry API
               c.Cloudbuild API
            2. After creating the Prophet gcloud project follow the below steps:
               a. go to gcloud storage of Prophet gcloud project then click on create bucket.
            ...
            4. Then select your Prophet created project, in service account details add service name "your unique service name"(service name should be unique) and click on "create and 
            ...
            6. Created key will get downloaded in .json format, copy that downloaded file in the given Prophet code
      ...
      NOTE: For the environment variable, ".json" and "/" is mandatory in there respective environment variable value
       ...
       11: Hit the create, this will create the service on port 2000 and will generate the url, hit the url.

       12. Copy the generated Prophet gcloud url and paste it in sticky notes for further use
      13. Generated url is : https://spmprophet10-uu2l6amtuq-uc.a.run.app
